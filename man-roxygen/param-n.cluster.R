...
#' available. On a local computer, this limit will the number of cores in the 
#' computer. In a PBS batch system, the maximum number of processes will be set 
#' from the PBS node file.
